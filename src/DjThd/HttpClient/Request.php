...
//    public function __construct(ConnectorInterface $connector, RequestData $requestData)
    public function __construct($connection, RequestData $requestData)
    {
...
//        $promise = $this->connect();
    ...
    public function handleData($data)
    {
        ...
        if (false !== strpos($this->buffer, "\r\n\r\n")) {
            ...
            $normalizedHeaders = array_change_key_case($response->getHeaders(), CASE_LOWER);
            if(strtolower($normalizedHeaders['connection']) === 'keep-alive') {
